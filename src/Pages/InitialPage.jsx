          ...
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                {
                  name: 'Raj K.',
                  quote: "Interactive Quiz support is a game changer. Now I study even on bus rides!",
                }
              ].map((testimonial, idx) => (
          ...
          <div className="max-w-7xl mx-auto px-6 py-10 grid sm:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                <li><strong>College:</strong> XYZ University</li>
                <li><strong>Occupation:</strong> Student Developer</li>
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-2">
                <a href="https://github.com/Ghost-hue-ai" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600">
                  <GitHub size={20} />
                </a>
                <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600">
                  <Twitter size={20} />
                </a>
                <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600">
                  <Linkedin size={20} />
                </a>
                <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600">
                  <Instagram size={20} />
                </a>
