...
function FlagQuiz() {
    ...
    const createRandomBtns = useCallback(() => {
        const remaining = countriesName.filter(name => !usedCountries.includes(name));
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
            <h1 className="text-4xl font-bold text-purple-400 mb-8 tracking-wide animate-pulse">🌍 Flag Quiz Game</h1>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                            {options.map((option, i) => {
                                ...
                                const baseStyles = "w-full py-4 px-6 text-lg font-semibold rounded-xl transition-all duration-300 shadow-lg";
                                ...
                                return (
                                    ...
                                    >
                                        {option}
                                        {isClicked && isCorrect && <CheckCircle className="ml-2" />}
