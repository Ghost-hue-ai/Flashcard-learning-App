                            ...
                            {predefinedSubjects.map((subject) => (
                                <div
                                    onClick={() => {
                                        ...
                                        } else if (subject.name.toLowerCase().includes("english")) {
                        ...
                        <ul className="flex flex-col gap-3 max-h-[350px] pr-2 overflow-scroll">
                            {recentLogs && recentLogs.length > 0 ? (
                                recentLogs.map((log, i) => (
                                    <li key={i} className="text-sm text-gray-700">{log}</li>
                                ))
                            ) : (
                                <li className="text-sm text-gray-500 italic">No Recent Logs</li>
                            )}
                        </ul>
                    </div>
