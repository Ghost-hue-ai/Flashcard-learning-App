...
const LearnSpanish = () => {
  const completedCards = useSelector(
  ...
  return (
    <>
      <SEO
        title="Learn Spanish | Flashcard Learning App"
        description="Practice and master Spanish vocabulary and grammar with interactive flashcards."
      />
      {loading ? (
