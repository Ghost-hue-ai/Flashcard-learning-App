...
function YourProfile() {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-900 text-white py-10 px-6 sm:px-12">
            <h2 className="text-3xl font-bold text-purple-400 mb-8">Your Profile</h2>
            ...
            <div className="space-y-6">
                {fields.map(({ label, value }) => (
                    <div key={label} className="bg-gray-800 p-5 rounded-md shadow-inner border border-gray-700">
                        <p className="text-sm text-purple-300 uppercase tracking-wide font-semibold">{label}</p>
                        {value ? (
