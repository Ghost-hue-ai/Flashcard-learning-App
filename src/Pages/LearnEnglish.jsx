...
import {updateCard, updateEnglishCardData, updateRecentLogs} from "../store/CompletedCard.js";
                      ...
                      if(completedCards[dictId]){
                        ...
                        return <div key={dictId} className="flex justify-around ">
                          <FlashCard
                              ...
                              handleClick={({ id, selectedChoice, correctAnswer,completed }) => {
                                setTimeout(()=> {
                                  dispatch(updateCard({
                                    id,
                                    selectedChoice,
                                  ...
                                  dispatch(updateRecentLogs(`Completed English Learning Flashcard #${dict.id}`))
                                },4000)
