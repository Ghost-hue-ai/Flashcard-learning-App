...
function FlashcardPage() {
  ...
  return (
    <>
      <SEO
        title="Flashcards | Flashcard Learning App"
        description="Practice and manage your flashcards for any subject. Create, edit, and review cards to master your studies."
      />
