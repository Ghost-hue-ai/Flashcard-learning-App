...
import { updateProfilePic, updateRecentLogs, updateUserData } from "../store/CompletedCard.js";
...
function UpdatePage() {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-900 text-white py-10 px-6 sm:px-10">
            <form
                onSubmit={async (e) => {
                    ...
                    try {
                        ...
                        await appService.updateUserName(`${formData.firstName} ${formData.lastName}`);
            ...
            >
                <h2 className="text-3xl font-bold text-center text-purple-400">Update Your Profile</h2>
                ...
                <div
                    ...
                    ${dragging ? 'border-purple-500 bg-purple-100' : 'border-gray-500 bg-gray-800'}
                `}
                >
                    {preview ? (
                        <img
                ...
                <textarea name="description" placeholder="Short Description" value={formData.description}
                          onChange={handleChange} rows={3}
                          className="w-full p-3 bg-gray-800 border border-gray-600 rounded-md focus:ring-2 focus:ring-purple-500" />

                <div className="grid md:grid-cols-2 gap-6">
                    <input name="twitter" placeholder="Twitter URL" value={formData.twitter} onChange={handleChange}
                           className="p-3 bg-gray-800 border border-gray-600 rounded-md focus:ring-2 focus:ring-purple-500" />
                ...
                <textarea name="about" placeholder="More about you..." value={formData.about}
